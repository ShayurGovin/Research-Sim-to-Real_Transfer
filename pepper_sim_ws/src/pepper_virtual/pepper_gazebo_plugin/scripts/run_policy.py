...
def main():
    ...
    ap.add_argument("--image_topic", default="/pepper/camera/front/image_raw")
    ap.add_argument("--caminfo_topic", default="/pepper/camera/front/camera_info")
    ap.add_argument("--scan_topic", default="/pepper/scan_front")
    ap.add_argument("--cmd_topic", default="/pepper/cmd_vel")
